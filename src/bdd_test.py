...
def create_elasticsearch_index():
    ...
    result = es.search(index="reviews", **query_all)
    ...
    result = es.search(index=index_name, **query_positive_words)
    ...
    result = es.search(index=index_name, **query_negative_words)
    ...
    result = es.search(index="reviews", **query_rating_stats)
    ...
    result = es.search(index=index_name, **query_negative_reviews)
    ...
    result = es.search(index=index_name, **query_no_reply)
    ...
    result = es.search(index=index_name, **query_average_rating)
    ...
    result = es.search(index=index_name, **query_statuses)
    ...
    result = es.search(index=index_name, **query_average_day)

    # Récupération des résultats
    companies = result["aggregations"]["companies"]["buckets"]

    # Tri des entreprises par leur délai de réponse moyen
    ...
    result = es.search(index=index_name, **query_no_reply_stats)
    # Récupération des résultats
